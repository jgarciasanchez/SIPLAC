...
<script src='{{asset('assets/fullcalendar/packages/interaction/main.js')}}'  ></script>
<script src='{{asset('assets/fullcalendar/packages/daygrid/main.js')}}'  ></script>
<script src='js/fullcalendarActiv.js'></script>
  ...
  <div class="row">
    ...
    <div  class="col-3">
      ...
      <div id='external-events'> <!---- CODIGO CALENDAR LLAMADO A UNAS FUNCIONES --------------------------------------------->
            <div class="form-group">      <!---------------Seleccion de actividad filtro------------->
              {!! Form::label('atividad','Atividad') !!}
              <select name="actividad_select" id="actividad_select" class="form-control">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form name="form" action="" method="get">
          <h5 class="modal-title"   name="tituloEvento" id="tituloEvento">Asignacion de actividades</h5>
        </form>
      ...
      <div class="modal-body"> 
        ...
        <div class="row">
           <div class="col-sm-6">
              <div class="form-group">
                {!! Form::label('nombres','Encargado de actividad') !!}
                {!! Form::text('nombres',old('nombres'),['class'=>'form-control','placeholder'=> 'Nombres']) !!}
              </div>
