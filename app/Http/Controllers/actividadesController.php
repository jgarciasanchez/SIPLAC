...
class actividadesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $act = $request->get('actividad_select');  //Busqueda por actividad
        $encargado = $request->get('nombres');

        $actividades = Actividades::filtro($act, $encargado);
       ...
       //dd($queries);
        ...
        return view('actividades.index',compact('cursos','aulas','ciclos','grupos','carrera','nivel','horarios','HorariosTodos'));
    }
